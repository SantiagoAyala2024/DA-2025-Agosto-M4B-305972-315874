...
public class DatosPrueba {
    ...
    public static void cargar(){
        ...
        fachada.agregarPropietario("23456789", "a", "Marcos", 2500, 100); 
        
        fachada.agregarPropietario("12345678", "b", "Pablo", 3500, 200); 

        fachada.agregarPropietario("34567891", "c", "Juan", 1500, 300);

        fachada.agregarAdministrador("12345677", "b", "Manuel");
        ...
        propietario3.crearVehiculo("ABD124", "Fiat", "Verde", fachada.getCategorias().get(2));
