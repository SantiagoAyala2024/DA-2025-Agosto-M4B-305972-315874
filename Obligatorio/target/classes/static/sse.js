...
function registrarSSE(){
    ...
    if (urlRegistroSSE !== null) {
        ...
        eventSourceSSE = new EventSource(urlRegistroSSE,{withCredentials: true });
        ...
        eventSourceSSE.onerror = function (event) {
...
// Función para cerrar la conexión SSE manualmente
function cerrarSSE() {
    if (eventSourceSSE !== null) {
        eventSourceSSE.close();
        eventSourceSSE = null;
...
// Cerrar la conexión SSE cuando se sale de la página
